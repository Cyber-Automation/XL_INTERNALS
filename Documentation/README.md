...
Engineering division. Develops toolkits, guides and scripts for practical integration into development workflows.
...
> Navigate to the corresponding division on (https://script-coding.ru) for detailed documentation, usage examples and release notes.

<hr style="border: none; height: 2px; background: linear-gradient(to right, #ff6b6b, #4ecdc4); margin: 20px 0;">

# Документация (RU)

Полная документация доступна на форуме проекта: (https://script-coding.ru)

## Подразделения форума

### `Cyber_Automation`

Инженерное подразделение. Разрабатывает инструментарий, гайды и скрипты для внедрения в свою деятельность.
