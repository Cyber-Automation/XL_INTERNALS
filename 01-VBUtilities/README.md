...
|VBUtil_MediaPlayer|Воспроизведение аудио внутри Excel без сторонних программ|
|VBUtil_XFormExcel|Фреймворк для standalone GUI-приложений с скрытым интерфейсом Excel|
